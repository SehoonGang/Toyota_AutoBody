        ...
        for frame in tqdm(source_list, total = len(source_list)) :
            ...
            if current_model == 'LH' :                
                if frame_number == '1' :
                    ...
                    circles2d = self.find_circle_center(texture_image=texture_path, detect_circle_setting=detect_circle_setting,x= 452, y= 1202, r = 100)
                    if circles2d:
                        detected_circle_centers[frame_number].append(circles2d[0])
                    ...
                    circles2d = self.find_circle_center(texture_image=texture_path, detect_circle_setting=detect_circle_setting, x=2072, y=634, r= 100)
                    if circles2d:
                        detected_circle_centers[frame_number].append(circles2d[0])
            else :
                if frame_number == '1':
